...
-- テスト用のRSSソースを追加
INSERT INTO news_sources (company_id, name, url, category) VALUES
('00000000-0000-0000-0000-000000000001', 'NHK NEWS WEB', 'https://www3.nhk.or.jp/news/', 'it'),
('00000000-0000-0000-0000-000000000001', 'ITmedia NEWS', 'https://www.itmedia.co.jp/news/', 'it'),
('00000000-0000-0000-0000-000000000001', 'CNET Japan', 'https://japan.cnet.com/', 'it');

-- テスト用のユーザーを追加
INSERT INTO users (company_id, email, full_name, role) VALUES
('00000000-0000-0000-0000-000000000001', 'admin@test.com', 'テスト管理者', 'admin'),
('00000000-0000-0000-0000-000000000001', 'editor@test.com', 'テスト編集者', 'editor');
